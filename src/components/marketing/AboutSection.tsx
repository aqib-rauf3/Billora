...
export default function AboutSection() {
  return (
    <section id="about" className="scroll-mt-20 py-16 max-w-6xl mx-auto">
      <FadeInSection>
        <div className="text-center px-7 mb-10">
          <span className="inline-block bg-redBg text-red text-xs px-3 py-1 rounded-full mb-4">
            Our story
          </span>
          <h2 className="text-2xl md:text-[28px] font-medium text-navy mb-3 max-w-lg mx-auto">
          ...
          {VALUES.map((v, i) => (
            <FadeInSection key={v.title} delay={i * 0.08}>
              <div className="bg-white rounded-lg p-5 h-full">
                ...
                <p className="text-sm font-medium text-navy mt-2.5 mb-1">{v.title}</p>
